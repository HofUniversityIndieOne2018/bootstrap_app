...
{
    /**
     * @var \HofUniversity\BootstrapApp\Controller\LocationController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\HofUniversity\BootstrapApp\Controller\LocationController::class)
    ...
    public function listActionFetchesAllLocationsFromRepositoryAndAssignsThemToView()
    {
        ...
        $locationRepository = $this->getMockBuilder(\HofUniversity\BootstrapApp\Domain\Repository\LocationRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $location = new \HofUniversity\BootstrapApp\Domain\Model\Location();
